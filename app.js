      ...
      function displayEmployees(data) {
        ...
        function modals() {
          ...
          function modalTemplate(i) {
             ...
             $(`<div class="modal fade" data-toggle="modal" data-target="#modal${i}" tabindex="${i}" id="modal${i}" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <button type="button" id="prev" class="btn btn-secondary prev" data-dismiss="modal" data-toggle="modal" aria-labelledby="ModalWindow" data-target="#modal${i-1}" >Prev</button>
                  <button type="button" id="next" class="btn btn-secondary next" data-dismiss="modal" data-toggle="modal" aria-labelledby="ModalWindow" data-target="#modal${i+1}" >Next</button>
                </div>
              </div>
            </div>
          </div>`).modal(focus);
          ...
          $('li').each(function (i) { //loop each employee card
          $(`#employee${i}`).click(function() {
            modalTemplate(i); //run modal HTML
        ...
        //THIS HIDES THE NEXT AND PREV BUTTONS FROM FIRST AND LAST CARDS.
